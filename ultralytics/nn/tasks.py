...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 RepNCSPELAN4, RepNCSPELAN4_high, ADown, RepC3_WTConv,RepC3_BFAM):
            c1, c2 = ch[f], args[0]
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, Blocks, VoVGSCSP, CSPStage,
                     RepNCSPELAN4, RepNCSPELAN4_high, RepC3_WTConv,RepC3_BFAM):
                args.insert(2, n)  # number of repeats
                n = 1
                             
        elif m in {Dy_Sample, ContextGuidedBlock_Down, CA, EMA, MultiDilatelocalAttention, ACmix, deformable_LKA, LSKA,
                   TripletAttention, DAttentionBaseline, BiLevelRoutingAttention,SCSA}:
            c2 = ch[f]
            args = [c2, *args]
            ...
            args = [ch[f[-1]]]
                   ...
                   EMO_1M, EMO_2M, EMO_5M, EMO_6M,MobileNetV4ConvSmall,MobileNetV4ConvLarge,MobileNetV4ConvMedium,
